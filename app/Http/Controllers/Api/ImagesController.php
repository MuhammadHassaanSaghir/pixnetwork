...
class ImagesController extends Controller
{
    ...
    public function searchImage(SearchImageRequest $request)
    {
        try {
            ...
            $images = Images::orWhere('image_name', 'like', '%' . $request->search . '%')->orWhere('extension', 'like', '%' . $request->search . '%')->orWhere('privacy', 'like', '%' . $request->search . '%')->orwhereDate('created_at', $request->search)->where('user_id', $request->user_id)->get();
            if (json_decode($images)) {
